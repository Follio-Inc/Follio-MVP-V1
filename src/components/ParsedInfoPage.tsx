...
const ParsedInfoPage: React.FC<ParsedInfoPageProps> = ({ uploadedFile, initialData, onSave, onBack }) => {
  ...
  const headerAction = (
    <div className="flex items-center gap-3">
      <button
        onClick={onBack}
        className="inline-flex items-center gap-2 rounded-full border border-slate-200 bg-white/70 px-4 py-2 text-sm font-medium text-slate-600 shadow-sm transition hover:border-blue-300 hover:text-slate-900"
      >
      ...
      <button
        ...
        className="inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-blue-600 to-sky-500 px-5 py-2 text-sm font-semibold text-white shadow-lg shadow-blue-500/30 transition hover:-translate-y-0.5 hover:shadow-xl disabled:cursor-not-allowed disabled:opacity-60"
      >
                  ...
                  <div className="grid gap-6 md:grid-cols-2">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full rounded-2xl border border-slate-200 bg-slate-50/50 px-4 py-3 text-sm font-medium text-slate-900 outline-none transition focus:border-blue-400 focus:bg-white focus:ring-4 focus:ring-blue-100"
                      />
                    </div>
                    <div>
              ...
              {expandedSections.education && (
                <div className="space-y-6 px-8 pb-8">
                  {parsedData.education.map((edu, index) => (
                    <div key={edu.id} className="rounded-3xl border border-sky-200 bg-sky-50/30 p-6 transition hover:bg-sky-50/50 hover:shadow-lg hover:shadow-sky-500/5">
                      <div className="mb-5 flex items-center justify-between">
                        <h3 className="text-xs font-bold uppercase tracking-wide text-sky-700 bg-sky-100/50 px-3 py-1 rounded-full ring-1 ring-sky-200">Education #{index + 1}</h3>
                        <button
                  ...
                  <button
                    ...
                    className="inline-flex items-center gap-2.5 rounded-full border border-sky-200 bg-sky-50 px-6 py-3 text-sm font-bold text-sky-700 transition hover:bg-sky-100 hover:shadow-sm"
                  >
                    <Plus className="h-4 w-4" />
                    Add education
                  </button>
